    ...
    <el-form ref="loginForm" :model="loginForm" :rules="loginRules" class="login-form" autocomplete="on" label-position="left">
      ...
      <div style="position:relative">
        <div class="tips">
          ...
          <a @click="registerActive = !registerActive">Sign up here</a>
        </div>
      </div>
    </el-form>
    </div>
      ...
      <el-form class="login-form" autocomplete="on" label-position="left">
        ...
        <div style="position:relative">
          <div class="tips">
            ...
            <a @click="registerActive = !registerActive">Login here</a>
          </div>
        </div>
      </el-form>
    </div>
...
import { createMember } from '@/api/role'
...
export default {
  ...
  methods: {
    ...
    handleLogin() {
      if(this.loginForm.username === 'user2' && this.check === false) {
        this.$message({
        type: 'warning',
    ...
    handleSignup() {
      let user = {name: this.username1, password: this.password1}
      console.log(user)
      createMember(user)
        .then(async() => {
          this.$message({
