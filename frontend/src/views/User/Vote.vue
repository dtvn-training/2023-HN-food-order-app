<template>
    <div class="votes">
        ...
        <div class="vote-data">
            <Table :columns="columns" :datas="votes" :actions="actions" @onClickAction="handleAction" />
        </div>
        <VoteCreate v-show="voteCreate == 1" @onClickCancel="handleCancel" @resultEvent="getVotes"/>
    </div>
</template>
